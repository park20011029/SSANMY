...
class Comment(models.Model):
    ...
    post_id = models.BigIntegerField(db_column='POST_ID')  # Field name made lowercase.
...
class Site(models.Model):
    ...
    post_id = models.BigIntegerField(db_column='POST_ID')  # Field name made lowercase.
    comp_id = models.CharField(db_column='COMP_ID', max_length=255)  # Field name made lowercase.
